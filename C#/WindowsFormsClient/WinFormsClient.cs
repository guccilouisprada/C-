...
namespace WinFormsClient
{
    ...
    public partial class WinFormsClient : Form
    {
        ...
        private void ButtonSend_Click(object sender, EventArgs e)
        {
            ...
            HubProxy.Invoke("SendOtvet", UserName, TextBoxMessage.Text);
        ...
        private async void ConnectAsync()
        {
            ...
            HubProxy.On<string, string>("AddMessage", (name, message) =>
               this.Invoke((Action)(() =>
                    richTextBox1.AppendText(String.Format("{0}: {1}\r", name, message))
                ))
            );
            try
            {
            ...
            TextBoxMessage.Focus();
            richTextBox1.AppendText("Connected to server at " + ServerURI + "\r");
        }
